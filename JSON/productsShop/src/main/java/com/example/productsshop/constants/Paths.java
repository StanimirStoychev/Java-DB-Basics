...
public enum Paths {
    ...
    public static final Path PRODUCTS_IN_RANGE_OUTPUT_PATH =
            Path.of("src/main/resources/output/products-in-range.json");
    public static final Path USER_SOLD_PRODUCTS_OUTPUT_PATH =
            Path.of("src/main/resources/output/users-sold-products.json");
    public static final Path CATEGORIES_BY_PRODUCTS_OUTPUT_PATH =
            Path.of("src/main/resources/output/categories-by-products.json");
